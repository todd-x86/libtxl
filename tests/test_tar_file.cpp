...
{
    return txl::time::to_time_point(s, "%Y%m%d-%H:%M:%S");
}
...
TXL_UNIT_TEST(simple_tar)
{
    ...
    expected.emplace_back(
        ...
        get_time_point("20250815-22:28:18"),
        txl::tar_entry::directory
    );
    expected.emplace_back(
        ...
        get_time_point("20250815-22:28:17"),
        txl::tar_entry::file,
        17,
